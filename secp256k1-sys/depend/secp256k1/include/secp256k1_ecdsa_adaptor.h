 ...
 *    - refactor adaptor verify to reuse code from rustsecp256k1_v0_1_2_ecdsa_verify()
 ...
 */
SECP256K1_API int rustsecp256k1_v0_1_2_ecdsa_adaptor_sig_verify(
    const rustsecp256k1_v0_1_2_context* ctx,
 ...
 */
SECP256K1_API int rustsecp256k1_v0_1_2_ecdsa_adaptor_adapt(
    const rustsecp256k1_v0_1_2_context* ctx,
 ...
 *                adaptor: pointer to the adaptor point (cannot be NULL)
 */
SECP256K1_API int rustsecp256k1_v0_1_2_ecdsa_adaptor_extract_secret(
    const rustsecp256k1_v0_1_2_context* ctx,
    unsigned char *adaptor_secret32,
    const rustsecp256k1_v0_1_2_ecdsa_signature *sig,
    const unsigned char *adaptor_sig65,
    const rustsecp256k1_v0_1_2_pubkey *adaptor
